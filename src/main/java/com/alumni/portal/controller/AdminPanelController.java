...
public class AdminPanelController {
    ...
    public String controlPanel(Model model) {
        model.addAttribute("totalAlumni", alumniService.getAlumniOnly().size());
        model.addAttribute("totalStudents", alumniService.getStudentsOnly().size());
        ...
        model.addAttribute("event", new com.alumni.portal.model.Event());

        java.util.List<com.alumni.portal.model.Alumni> people = alumniService.getAlumniOnly();
